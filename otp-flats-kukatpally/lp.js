// Sidebar / contact form submission for the Kukatpally OTP landing page
  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      const res = await fetch('https://formspree.io/f/mjgpzezo', {
        ...
        body: JSON.stringify({ name, phone, config, page, project: 'OTP Flats Kukatpally (Metro / GOCL - Hi-Rise 3 BHK)' }),
      });
      if (res.ok) {
