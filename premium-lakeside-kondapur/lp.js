// Sidebar / contact form submission for the Kondapur lakeside landing page
  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      const res = await fetch('https://formspree.io/f/mjgpzezo', {
        ...
        body: JSON.stringify({ name, phone, config, page, project: 'Premium Lakeside Kondapur (Candeur Lakescape)' }),
      });
      if (res.ok) {
