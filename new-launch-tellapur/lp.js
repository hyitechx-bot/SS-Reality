// Sidebar / contact form submission for the Tellapur pre-launch landing page
  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      const res = await fetch('https://formspree.io/f/mjgpzezo', {
        ...
        body: JSON.stringify({ name, phone, config, page, project: 'New Pre-Launch Tellapur (Rajapushpa Sierra)' }),
      });
      if (res.ok) {
