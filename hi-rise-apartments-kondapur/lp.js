// Sidebar / contact form submission for the Kondapur hi-rise landing page
  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      const res = await fetch('https://formspree.io/f/mjgpzezo', {
        ...
        body: JSON.stringify({ name, phone, config, page, project: 'Hi-Rise Apartments Kondapur (Vrindavan)' }),
      });
      if (res.ok) {
