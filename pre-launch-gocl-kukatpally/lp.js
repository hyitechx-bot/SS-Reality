// Sidebar / contact form submission for the Kukatpally GOCL pre-launch landing page
  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      const res = await fetch('https://formspree.io/f/mjgpzezo', {
        ...
        body: JSON.stringify({ name, phone, config, page, project: 'Pre-Launch GOCL Kukatpally (SAS Infra Kukatpally IDL)' }),
      });
      if (res.ok) {
